...
(defn ping-handler
  ...
  (println "http-handlers/ping-handler: redis-component:\n"
           redis-component)
  (redis-component/ping-redis redis-component))
...
(defn counter-handler
  ...
  (let [ip-address     (:remote-addr http-request)
    ...
    (println "http-handlers/counter-handler: ping-count:\n"
             ping-count)
    (println "http-handlers/counter-handler: (redis-component/increment-ping-count redis-component ip-address):\n"
             ping-count)
    (str "Ping count: "
         (redis-component/increment-ping-count redis-component ip-address))))